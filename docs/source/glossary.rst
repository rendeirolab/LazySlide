...
.. glossary::
   ...
   magnification
      Nominal optical zoom associated with a :term:`WSI`, commonly written as 20x or 40x.
      It is related to, but not interchangeable with, the physical pixel size measured in :term:`mpp`.
   ...
   contour
   contours
      Closed boundaries outlining tissue regions in a WSI (e.g., tumor areas or stroma),
...
.. glossary::
   ...
   accuracy
      The proportion of evaluated predictions that are correct. For highly imbalanced segmentation classes,
      interpret it together with class-specific metrics.

   precision
      The proportion of positive predictions that are true positives.

   recall
      The proportion of true positive cases that are detected. Also called sensitivity.
