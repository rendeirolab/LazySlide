...
def test_get_crop_xy_wh():
    ...
    # upper-left
    assert test_func(left=-10, top=-10, width=20, height=20) == (
        0,
        0,
        10,
        10,
    ...
    # lower-left
    assert test_func(left=-10, top=90, width=20, height=20) == (
        0,
        90,
        10,
        10,
    ...
    # upper-right
    assert test_func(left=190, top=-10, width=20, height=20) == (
        190,
        0,
        10,
        10,
    ...
    # lower-right
    assert test_func(left=190, top=90, width=20, height=20) == (
        190,
        90,
        10,
        10,
